...
09. IfRandom05	   : [문제3] 0점부터 100점 사이의 난수를 발생시켜서 등급을 나눠라 (선생님 풀이)
---------------------------------------------------------------------------------------------------------------------------------------
...
21. SwitchExample01	   : [문제1] 0점부터 100점 사이의 난수를 발생시켜서 등급을 나눠라 (난수를 등급단위로 발생(A~F))_switch문 초반에 변수 선언
---------------------------------------------------------------------------------------------------------------------------------------
...
33. ForExample05	   : [문제5] 임의의 수에서 임의의 배수를 구하라.
---------------------------------------------------------------------------------------------------------------------------------------
...
39. WhileBreak01	   : [문제1] 구구단 출력. 처음 만나는 계산된 결과 값이 30보다 크면, 전체 반복문을 탈출
40. WhileExample01	   : while로 구구단 만들기
---------------------------------------------------------------------------------------------------------------------------------------
41. DoWhileStatement01 : [반복문 do while]			do while문의 특징 : 기본 특징
42. DoWhileStatement01A

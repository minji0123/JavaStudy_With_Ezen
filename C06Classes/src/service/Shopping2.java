...
public class Shopping2 {
	...
	public static void main(String[] args) {
		Shopping2 shop = new Shopping2("김여사"); // 기본생성자
		shop.printInfo();
		...
		System.out.println("-----------------------------------");
		Shopping2 shop2 = new Shopping2("홍여사", "명품백", 300, 4, 1200);
	...
	static boolean globalAmountLimit(Shopping2 shop) {
	...
	void printInfo(String title) { // 메소드(멤버함수)
	...
	Shopping2(String cust) { // 구매자를 파라미터로 하는 생성자
		customer = cust;
	 ...
	 *          구매 단가 * 구매 수량 = 금액
	 */
	Shopping2(String customer, String goods, int price, int quantity, int amount) { // 전체 속성을 파라미터로 하는 생성자

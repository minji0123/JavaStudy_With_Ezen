...
정답 : 3번
해설 : 
- JVM(Java Virtual Machine) 자바 가상 머신은 운영체제에 종속적이고
- 바이트 코드는 운영체제에 독립적이다.
...
[문제4] 자바 소스 파일을 작성할 때 틀린 것은 무엇입니까?
...
정답 : 4번
해설 : 
- 문자열은 쌍따음표로 감싸기 때문에 주석을 사용할 수 없다.

[문제5] 자바 주석문의 종류가 아닌 것은 무엇입니까?
1. // : 행 주석
2. /*...*/ : 범위 주석
3. /**...*/ : API 도큐먼트 주석
4. <!--...--> : 범위 주석
